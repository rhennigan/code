...
(function() {
  var Circle, Color, DrawingCanvas, Ellipse, Geometry, Line, Polygon, Polyline, Rectangle, initialize, ui,
  ...
  initialize = function() {
    var drawingCanvas, fractalCanvas;
    window.DrawingCanvas = DrawingCanvas;
    drawingCanvas = new DrawingCanvas();
    return fractalCanvas = new DrawingCanvas();
  };
