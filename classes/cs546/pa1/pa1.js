...
(function() {
  var BTN_BACKGROUND_DISABLED, BTN_BACKGROUND_ENABLED, BTN_TEXT_DISABLED, BTN_TEXT_ENABLED, Circle, Color, DrawingCanvas, Ellipse, Fractal, FractalCanvas, Geometry, Line, Polygon, Polyline, Rectangle, drawingCanvas, fractalCanvas, newPolylines, pl, polygon, polyline, ref, ref1, segments, ui,
  ...
  Fractal.prototype.split = function(polyline, segments) {
  ...
  newPolylines = (function() {
    var j, len1, results;
    results = [];
    for (j = 0, len1 = newPolylines.length; j < len1; j++) {
      pl = newPolylines[j];
