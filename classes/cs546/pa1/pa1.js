...
(function() {
  var Circle, Color, DrawingCanvas, Ellipse, Geometry, Line, Rectangle, drawingCanvas, shape,
  ...
  Geometry.prototype.createPrimitive = function(drawMode, mouse) {
    switch (drawMode) {
      case 'line':
        return new Line(mouse, mouse, new Color(0, 0, 0));
      case 'circle':
        return new Circle(mouse, 0, new Color(0, 0, 0));
      case 'ellipse':
        return new Ellipse(mouse, 0, 0, new Color(0, 0, 0));
      case 'rectangle':
        return new Rectangle(mouse, mouse, new Color(0, 0, 0));
      default:
        return new Line(mouse, mouse, new Color(0, 0, 0));
    }
  };
  ...
  DrawingCanvas = (function() {
    ...
    DrawingCanvas.prototype.refreshRate = 1000 / 1;

    DrawingCanvas.prototype.antialiasing = false;

    DrawingCanvas.prototype.drawMode = 'rectangle';
  ...
  drawingCanvas.graphicsPrimitives.push(new Line({
    x: 25,
    y: 30
  }, {
    x: 150,
