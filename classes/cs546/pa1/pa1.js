...
(function() {
  ...
  scaledPoints = (function() {
    ...
    for (j = 0, len1 = points.length; j < len1; j++) {
      pt = points[j];
      results.push(Geometry.prototype.vecSMul(scale, Geometry.prototype.vecSub(pt, first)));
    }
    return results;
  })();
