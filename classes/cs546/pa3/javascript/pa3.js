...
(function() {
  ...
  generalizedTransformation = function(scale, translation, shear, rotation, perspective, point) {
    var px, py, pz, ref, ref1, ref2, ref3, ref4, ref5, rx, ry, rz, sx, sxy, sxz, sy, syz, sz, tx, ty, tz, x, y, z;
    ...
    return ref5 = [point.x, point.y, point.z], x = ref5[0], y = ref5[1], z = ref5[2], ref5;
  };
