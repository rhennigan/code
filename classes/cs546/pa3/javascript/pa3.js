...
(function() {
  var Line, R_INC, SVG_SIZE, SVG_STROKE, callback, clear, createMeshLines, createSVGLine, err, generalizedTransformation, getVertexRanges, isometricProjection, load, loadObject, main, orthoProj, parseFace, parseVertex, rescaleVertices, rotate, transformVertices, transformationMatrix, union;
  ...
  transformVertices = function(object3D, scale, translation, shear, rotation, perspective) {
    var m;
    return m = transformationMatrix(scale, translation, shear, rotation, perspective);
  };
