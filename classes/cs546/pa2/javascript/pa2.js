...
(function() {
  var Line, R_INC, SVG_SIZE, SVG_STROKE, callback, clear, createMeshLines, createSVGLine, err, getVertexRanges, load, loadObject, main, orthoProj, parseFace, parseVertex, rescaleVertices, rotate, union;
  ...
  callback = function(obj, txt) {
    var containerXY, containerXZ, containerYZ, createLabel, i, k, l, len1, len2, line, lineXY, lineXZ, lineYZ, lines, op, ref, ref1, svg, svgXY, svgXZ, svgYZ;
    lines = txt.split('\n');
    ...
    ref = (function() {
      ...
      return results;
    })(), svgXY = ref[0], svgXZ = ref[1], svgYZ = ref[2];
    ...
    return containerYZ.appendChild(svgYZ);
  };
  ...
  rotate = function(object3D, txy, txz, tyz) {
    var ctxy, ctxz, ctyz, i, k, meshLine, p1, p2, ref, rotatedVertices, s2x, s2y, s2z, size, stxy, stxz, styz, v, x, y, z;
    ctxy = Math.cos(txy);
    ctxz = Math.cos(txz);
    ctyz = Math.cos(tyz);
    stxy = Math.sin(txy);
