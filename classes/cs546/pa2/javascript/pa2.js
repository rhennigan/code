...
(function() {
  var Line, R_INC, SVG_SIZE, SVG_STROKE, callback, clear, createMeshLines, createSVGLine, err, getVertexRanges, isometricProjection, load, loadObject, main, orthoProj, parseFace, parseVertex, rescaleVertices, rotate, union;
